  ...
  return (
    <section className="contact" id="contact">
      ...
      <div className="contact__grid reveal">
        ...
        {/* Phone */}
        <a href={phoneUrl} className="contact-btn contact-btn--phone">
          <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
          </svg>
          <div>
            <strong>Call Us</strong>
            <span>{contact?.phone || '+91 999 505 6728'}</span>
          </div>
        </a>
        ...
        <a href={emailUrl} className="contact-btn contact-btn--email">
          ...
          <div>
            <strong>Email</strong>
            <span>{contact?.email || 'hello@zuloo.studio'}</span>
          </div>
        </a>

        {/* Instagram */}
        <a href={instaUrl} target="_blank" rel="noopener noreferrer" className="contact-btn contact-btn--instagram">
          <svg viewBox="0 0 24 24" width="28" height="28" fill="currentColor" aria-hidden="true">
          ...
          <div>
            ...
            <span>@{contact?.instagram || 'zuloo.studio'}</span>
          </div>
        </a>
      </div>
    </section>
